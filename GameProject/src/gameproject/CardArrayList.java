      ...
      for (Color color : Color.values()) {
         for (int i = 0; i < 2; i++) {
            for (CardFaceValue cardFaceValue : CardFaceValue.values()) {
               ...
               if (!(cardFaceValue.equals(CardFaceValue.WILD) || cardFaceValue.equals(CardFaceValue.WILD_FOUR) || cardFaceValue.equals(CardFaceValue.PICK_TWO) || cardFaceValue.equals(CardFaceValue.SKIP)
                     || cardFaceValue.equals(CardFaceValue.REVERSE))) {
